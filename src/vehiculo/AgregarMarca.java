    ...
    public void agregarMarca(){
        ...
        if(Lib.validaString(txt_marca.getText())){
            ...
            if( ok == 0){
                ...
                JOptionPane.showMessageDialog(this,"La marca ya se encuentra registrada","Dato duplicado",JOptionPane.ERROR_MESSAGE);
                System.err.println("El Nombre de la marca existe");
            }
        }else{
            
           JOptionPane.showMessageDialog(this,"Escriba el nombre de la marca","Dato Invalido",JOptionPane.ERROR_MESSAGE);
